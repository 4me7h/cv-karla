...
const Content = (props) => {
    const {name, position, company, aboutText, email, phone, whatsapp, whatsappmssg, address} = props;
                    ...
                    <Col>
                        <div className="content__container">
                            ...
                            <div className="content__contact">
                                ...
                                <span className="content__contact__twitter">Dirección: <a href={address} target="_blank" rel="noreferrer">{address}</a></span>
                            </div>
                        </div>
                    </Col>
                </Row>
